...
class Banner extends React.Component {
  render() {
    if (this.props.current_source == null) return React.createElement("div", null); // var source = this.props.source_set[this.props.current_source];
...
class App extends React.Component {
  ...
  componentWillReceiveProps(newProps) {
    if (this.props.source != newProps.source && newProps.source != null) this.setSource(newProps.source);
  }

  setSource(source) {
    if (isEmptyObject(source)) return false;
  ...
  render() {
    if (isEmptyObject(this.props.source)) return null; //
