...
class Report extends React.Component {
  ...
  generateTotals(minmax) {
    ...
    var measure_columns = this.props.measures.map(function (measure, i) {
      ...
      if (measure == '') return React.createElement("td", { key: i });else return React.createElement(
        "td",
        { className: "measure_cell", key: i },
    ...
    return React.createElement(
      "tr",
      null,
      React.createElement("td", { style: { 'borderRight': 'none' } }),
      React.createElement(
        "td",
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("th", { className: "report_heading", width: "200" }),
            measure_header
          ),
          rows,
          totals
