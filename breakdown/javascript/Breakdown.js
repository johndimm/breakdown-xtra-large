...
class Banner extends React.Component {
  ...
  render() {
    if (this.props.current_dataset == null) return (
      /*#__PURE__*/
      React.createElement("div", null)
    ); // var dataset = this.props.dataset_set[this.props.current_dataset];

    var dataset = this.props.dataset;
    var guideLink = this.props.dataset.page_title.indexOf('Breakdown for Mint') != -1 ? "mint.html" : "personal_capital.html";
    var cell1 =
    /*#__PURE__*/
    React.createElement("div", null,
    /*#__PURE__*/
...
class Breakdown extends React.Component {
  ...
  componentWillReceiveProps(newProps) {
    if (this.props.dataset != newProps.dataset && newProps.dataset != null) this.setSource(newProps.dataset);
  }

  setSource(dataset) {
    if (isEmptyObject(dataset)) return false;
    var current_dataset = dataset['name'];
    if (current_dataset == '') return false;
    this.setState({
  ...
  whereClause() {
    ...
    //
    var filter_array = [];
    if (this.state.report.filters != null) Object.getOwnPropertyNames(this.state.report.filters).forEach(function (row, i) {
  ...
  render() {
    if (isEmptyObject(this.props.dataset)) return null;
    ...
    var dimensions = this.getDimArray().map(function (row, i) {
      ...
      var title = '';
      if (!isEmpty(this.state.dataset.dim_metadata) && row in this.state.dataset.dim_metadata) title = this.state.dataset.dim_metadata[row];
      return (
        /*#__PURE__*/
    ...
    return (
      ...
      React.createElement(Banner, {
        current_dataset: this.state.current_dataset,
      ...
      /*#__PURE__*/
      React.createElement("td", null, report, right_side)))))
    );
  }
