...
class ImportInstructions extends React.Component {
  ...
  requestReload() {
    return React.createElement(
      "button",
      { id: "import_instructions_button", onClick: function () {
          location.reload();
        } },
  ...
  tryIt() {
    return React.createElement(
      "div",
      { id: "try_it", onClick: this.props.turnOnDisplayImportInstructions },
      React.createElement(
        "i",
        null,
  ...
  importInstructions() {
    ...
    return React.createElement(
      ...
      "  This program imports it into a small database system that runs on your computer and all analysis is done locally. The local javascript database is ",
      React.createElement(
        "a",
        {
      ...
      React.createElement(
        "h3",
        null,
        "Import a csv file into your local Lovefield database"
      ),
      React.createElement(
        "div",
        { id: "import_button", className: "upload-btn-wrapper" },
        React.createElement(
          "button",
          { className: "btn" },
          "Import"
        ),
        React.createElement("input", { type: "file", name: "files[]", id: "fileUpload", onChange: this.props.handleFileUpload })
      ),
      React.createElement("br", null),
      React.createElement(
        "i",
        null,
        "Note: your file never leaves your computer"
      ),
      React.createElement(
        "h3",
        null,
      ...
      React.createElement(
        ...
        React.createElement(
          "li",
          null,
          "get a csv file.  Here's one to try before using one of your own: ",
          React.createElement(
            "a",
        ...
        React.createElement(
          "li",
          null,
          "click the \"choose file\" button above and import the csv file."
        )
      ),
      React.createElement(
        "h3",
        null,
        "What sort of csv files works with breakdown?"
      ),
      React.createElement(
        "ul",
        null,
        React.createElement(
          "li",
          null,
          "the best candidates have text columns (dimensions) and number columns (measures) , the sort of data that would make a good pivot table."
        ),
        React.createElement(
          "li",
          null,
          "for examples, click on the Google Sheets links in the online demo list and download the csv file for the underlying data."
        ),
        React.createElement(
          "li",
          null,
          "the first line determines which columns are metrics (the ones that parse as a number) and which are dimensions (everything else)."
        ),
        React.createElement(
          "li",
          null,
          "Lovefield uses IndexedDB which currently has a limit of 50 Meg."
        )
      )
    );
  }
...
class Catalog extends React.Component {
  ...
  printDatasetLink(requestedDatabase, key, i, displayOption) {
    ...
    if (displayOption == 'full') {
      img = React.createElement("img", { src: key + '.jpg', width: "200" });
    ...
    var google_sheet = google_sheet != null && google_sheet != '' ? React.createElement(
      "div",
      null,
      React.createElement(
        "a",
        { target: "_blank", href: google_sheet },
        "google sheet"
      )
    ) : '';
    ...
    return React.createElement(
      "td",
      { key: i, className: className, title: titleText,
        onClick: function () {
          //
  ...
  render() {
    ...
    if (urlparam('dataset', '') != '') {
      ds = React.createElement(
        "div",
        { id: "datasets", className: "upload-btn-wrapper" },
        React.createElement(
          "div",
          { id: "catalog_title" },
          "Breakdown for Mint"
        ...
        React.createElement(
          ...
          React.createElement(
            "i",
            null,
            "Import the transactions.csv file you just downloaded from Mint"
          )
        ),
        React.createElement(
          "label",
          { className: "btn" },
          React.createElement("input", { type: "file", name: "files[]", id: "fileUpload", onChange: this.handleFileUpload.bind(this) }),
          "Import"
        ),
        React.createElement(
          "div",
          { id: "datasets_diagram" },
          React.createElement("img", { src: "images/lovefield.png" })
        ),
        React.createElement(
          "div",
          null,
    ...
    return React.createElement(
      ...
      null,
      ds,
      React.createElement(Breakdown, { dataset: this.state.dataset })
    );
  }
  ...
  render_v0() {
    ...
    var privateDataStyle = { 'display': localDatasets.length > 0 ? 'block' : 'none' };
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { id: "dataset_catalog_context_switch", onClick: function () {
            this.toggleDatasetsDisplay();
          }.bind(this) },
        "Datasets"
      ),
