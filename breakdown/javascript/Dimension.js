  ...
  render() {
    ...
    var dimValues = this.props.dimValues.map(function (key, i) {
      return React.createElement(
        "option",
        { key: i, name: this.props.name, value: key },
        key
      );
    }.bind(this));
    ...
    if (this.props.dimValues.length > 0) {
      selectDimValues = React.createElement(
        "select",
        { onChange: function (e) {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "td",
                { className: "prev_dim", onClick: function () {
              ...
              React.createElement(
                "td",
                { className: "next_dim", onClick: function () {
                    this.props.slideDim(this.props.name, this.props.selectedValue, 1);
                  }.bind(this) },
                rightArrow
              )
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: titleClass, onClick: this.props.setGroupby },
        React.createElement(
          "table",
          { className: "dim_table" },
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "td",
                { className: "dim_name", title: this.props.title },
                nameSpaced
              ),
              React.createElement(
                "td",
